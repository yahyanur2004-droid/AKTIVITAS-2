...
class HomeTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: const Color(0xFFF2F4F7),
      body: const Center(
        child: Text('Selamat datang di Home', style: TextStyle(fontSize: 18)),
      ),
    );
  }
}
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ClipRRect(
              borderRadius: BorderRadius.circular(80),
              child: Image.asset('assets/images/PAB.jpeg', width: 120, height: 120, fit: BoxFit.cover),
            ),
            const SizedBox(height: 16),
            const Text('Yahya Nur Nasywa H', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700)),
            const SizedBox(height: 8),
            const Text('1462300067', style: TextStyle(fontSize: 16)),
          ],
        ),
      ),
    );
